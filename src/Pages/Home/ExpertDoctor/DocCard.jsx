    ...
    <div className="card border  bg-base-100 ">
      ...
      <div className="card-body">
        ...
        <div className="text-gray-500 space-y-2">
            ...
            <p className="flex gap-4 items-center text-sm"><AiOutlineDollarCircle className="text-base"></AiOutlineDollarCircle> <span>Available On {moment(availableData).format("dddd, D MMM")}</span></p>
        </div>
        <div className="card-actions mt-5">
          <button className="btn btn-block border-2 hover:border-[#F7A582] border-[#F7A582] btn-outline hover:bg-[#F7A582] text-[#F7A582]">Buy Now</button>
        </div>
      </div>
    </div>
  );
